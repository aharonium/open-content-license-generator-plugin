...
function ccg_get_banner( $ccg_options, $who_call ) {
	...
	if ( $ccg_options['mod'] == "fu" ) {
	$banner = "<a target='_blank' rel='license nofollow' href='https://www.law.cornell.edu/uscode/text/17/107'><img class='alignright' alt='17 U.S. Code  107 - Limitations on exclusive rights: Fair use' style='border-width:0' src='http://opensiddur.org/wp-content/images/" . $image_attributes . ".svg.150x100.png' /></a><br />";
	...
	$banner = "<a target='_blank' rel='license nofollow' href='http://creativecommons.org/" . $licensedir . '/' . $attributes . '/' . $version ."/'><img class='alignright' alt=' . $attributes_text . $version . $versiontype .' style='border-width:0' src='http://opensiddur.org/wp-content/images/" . $image_attributes . ".svg.150x100.png' /></a><br />";
